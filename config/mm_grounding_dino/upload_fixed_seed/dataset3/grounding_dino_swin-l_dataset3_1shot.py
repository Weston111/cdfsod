...
# val_evaluator = dict(ann_file=data_root + 'annotations/test.json',format_only=True,outfile_prefix='dataset3_1shot')#,classwise=True)
test_evaluator = val_evaluator

max_epoch = 40

train_cfg = dict(_delete_=True,
    type='EpochBasedTrainLoop', max_epochs=1, val_interval=1)
