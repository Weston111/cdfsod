...
CHECKPOINT="output/awp/dataset3/10shot_adv_lr_1_eps001/best_coco_bbox_mAP_epoch_12.pth"
WORK_DIR="output_prompt/prompt_test_dataset3_10shot_awp"
mkdir -p $WORK_DIR
...
python -m torch.distributed.launch \
    ...
    $CHECKPOINT \
    --launcher pytorch \
    --class-names "dent" "glass shatter"  \
    --descriptions "deformed"\
    --descriptions "Fragmented" \
