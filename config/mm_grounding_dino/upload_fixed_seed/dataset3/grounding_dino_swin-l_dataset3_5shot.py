...
val_evaluator = dict(ann_file=data_root + 'annotations/test_annotations.json',format_only=True,outfile_prefix='dataset3_5shot')
...
default_hooks = dict(
    # _delete_=True,
    checkpoint=dict(by_epoch=True,interval=5, max_keep_ckpts=1, save_best='auto'),
