...
data_root = 'data/cdfsod/dataset2/'
class_name = ('car',)
...
test_pipeline = [
    ...
    dict(
        ...
        meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
                   ...
                   'tokens_positive','caption_prompt'))
]
...
# val_evaluator = dict(ann_file=data_root + 'annotations/test_annotations.json',classwise=True)
val_evaluator = dict(ann_file=data_root + 'annotations/test.json',format_only=True,outfile_prefix='dataset2_1shot')
...
# load_from = 'output/sft_cross/dataset3/1shot_large/best_coco_bbox_mAP_epoch_15.pth'
